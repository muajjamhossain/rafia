...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/service/update')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Update Service Information</h3>
                      </div>
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> update service information.
                          </div>
                        @endif
                ...
                <div class="form-group row custom_form_group{{ $errors->has('title') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Service Title:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row custom_form_group">
                    <label class="col-sm-3 control-label">Service Subtitle:</label>
                    <div class="col-sm-7">
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="details" rows="3">{{$data->service_details}}</textarea>
                    </div>
                </div>
                <div class="form-group row custom_form_group{{ $errors->has('pic') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Service Image:<span class="req_star">*</span></label>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-2">
                        @if($data->service_image!='')
                            <img class="img-thumbnail" src="{{asset('uploads/service/'.$data->service_image)}}" alt="image"/>
                        @else
