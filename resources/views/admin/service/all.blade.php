            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/service/add')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle"></i> Add Service</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->service_image!='')
                                                <img class="table_image_ban" src="{{asset('uploads/service/'.$data->service_image)}}" alt="image"/>
                                            @else
                                                <img class="table_image_ban" src="{{asset('uploads')}}/no-image-big.jpg" alt="image"/>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{url('dashboard/service/view/'.$data->service_slug)}}" title="view"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                                            <a href="{{url('dashboard/service/edit/'.$data->service_slug)}}" title="edit"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
