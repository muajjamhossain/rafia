                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    @php
                                        $all=App\Partner::where('partner_status',0)->orderBy('partner_id','DESC')->get();
                                    @endphp
                                    @foreach($all as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" title="restore" id="restore" data-toggle="modal" data-target="#restoreModal" data-id="{{$data->partner_id}}"><i class="fa fa-refresh fa-lg restore_icon"></i></a>
...
<div id="restoreModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{url('dashboard/partner/restore')}}"/>
              @csrf
              <div class="card mb-0">
                <div class="card-header">
