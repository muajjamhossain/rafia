            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/blog/post')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-th"></i> All Post</a>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    @php
                                        $all=App\BlogPost::where('post_status',0)->orderBy('post_id','DESC')->get();
                                    @endphp
                                    @foreach($all as $data)
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="#" title="restore" id="restore" data-toggle="modal" data-target="#restoreModal" data-id="{{$data->post_id}}"><i class="fa fa-refresh fa-lg restore_icon"></i></a>
...
<div id="restoreModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{url('dashboard/blog/post/restore')}}"/>
              @csrf
              <div class="card mb-0">
                <div class="card-header">
...
<div id="softDelModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{url('dashboard/blog/post/delete')}}"/>
              @csrf
              <div class="card mb-0">
                <div class="card-header">
                    <h3 class="card-title float-left"><i class="fa fa-gg-circle"></i> Confirm Message</h3>
