...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/faq/submit')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Add FAQ Information</h3>
                      </div>
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> add faq information.
                          </div>
                        @endif
                ...
                <div class="form-group row custom_form_group">
                    <label class="col-sm-3 control-label">Answer:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
