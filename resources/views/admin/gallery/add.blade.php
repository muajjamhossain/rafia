...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/gallery/submit')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('cate') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <select class="form-control" name="cate">
                            ...
                            <option value="{{$cate->gcate_id}}">{{$cate->gcate_name}}</option>
                            @endforeach
                      </select>
                      @if ($errors->has('cate'))
                          <span class="invalid-feedback" role="alert">
