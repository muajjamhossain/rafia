    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> All Contact Message</h3>
                    </div>
                            ...
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('dashboard/contactus/view/'.$data->conus_slug)}}" title="view"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
            ...
            <div class="card-footer card_footer_expode">
                <a href="{{url('dashboard/contactus/allprint')}}" class="btn btn-secondary waves-effect btnPrint">PRINT</a>
                <a href="{{url('dashboard/contactus/excel')}}" class="btn btn-warning waves-effect">EXCEL</a>
                <a href="{{url('dashboard/contactus/pdf')}}" class="btn btn-success waves-effect">PDF</a>
            </div>
        </div>
    </div>
</div>
...
<div id="softDelModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{url('dashboard/contactus/softdelete')}}"/>
              @csrf
              <div class="card mb-0">
                <div class="card-header">
