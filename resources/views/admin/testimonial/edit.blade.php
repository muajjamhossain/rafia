...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{url('dashboard/testimonial/update')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input type="text" class="form-control" name="name" value="{{$data->tm_name}}">
                      @if ($errors->has('name'))
                ...
                <div class="form-group row custom_form_group{{ $errors->has('designation') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="designation" value="{{$data->tm_designation}}">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('company') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="company" value="{{$data->tm_company}}">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('review') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" rows="5" name="review">{{$data->tm_review}}</textarea>
                ...
                <div class="form-group row custom_form_group{{ $errors->has('pic') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-2">
                        @if($data->tm_image!='')
                            <img class="img-thumbnail" src="{{asset('uploads/testimonial/'.$data->tm_image)}}" alt="image"/>
                        @else
