                        ...
                        <li class="dropdown d-none d-sm-block">
                            <a href="#" data-target="#" class="dropdown-toggle waves-effect waves-light"
                                ...
                                <i class="md md-notifications"></i> <span
                                    class="badge badge-pill badge-xs badge-danger">1</span>
                            </a>
                        ...
                        <li class="dropdown open">
                            <a href="#" class="dropdown-toggle profile" data-toggle="dropdown"
                                aria-expanded="true"><img
                                    src="{{ asset('assets/admin') }}/assets/images/users/avatar-1.jpg" alt="user-img"
                                    class="rounded-circle"> </a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ url('dashboard/profile') }}" class="dropdown-item"><i
                                            class="mr-2 md md-face-unlock"></i> Profile</a></li>
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="#" class="waves-effect"><i class="md md-photo-library"></i><span>Gallery
                        ...
                        <li class="has_sub">
                            <a href="#" class="waves-effect"><i class="md md-local-hospital"></i><span>Doctors
                                </span><span class="pull-right"><i class="md md-add"></i></span></a>
                            <ul class="list-unstyled">
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="{{ url('dashboard/newsletter/subscribe') }}">Newsletter Subscribe</a>
                                </li>
                            </ul>
                        </li>
